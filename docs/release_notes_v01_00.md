...
- [docs/release_checklist_v01_00.md](/Users/hiromasa/Documents/PlatformIO/Projects/m5stamp_bme688_poc/docs/release_checklist_v01_00.md)
  の項目をすべて確認済み
- Windows 11 上で `PyInstaller` による実行ファイル化とスモークテストを確認済み
- Git タグは `v01.00` を使用する

## 次版候補

次版で検討する改善候補は
[docs/next_version_backlog.md](/Users/hiromasa/Documents/PlatformIO/Projects/m5stamp_bme688_poc/docs/next_version_backlog.md)
に整理する。
